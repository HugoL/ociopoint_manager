...
<?php if( $web->tipo == 0 ) $tipo = "index"; else $tipo = "ipad"; ?>

<div class="span12 well well-small"><center><h2><?php echo $web->titulo; ?></h2></center></div>
<div class="span12">
	Dirección: <span class="label label-success"><?php echo "http://www.ociopoint.com/web/".$tipo."/id/".$web->usuario->profile->referencia; ?></span> Dirección corta: <span class="label label-info"><?php echo CHtml::encode($web->url); ?></span> Referencia: 
