...
CREATE TABLE `om_profiles_fields` (
...
INSERT INTO `om_users` (`id`, `username`, `password`, `email`, `activkey`, `superuser`, `status`) VALUES
...
INSERT INTO `om_profiles` (`user_id`, `lastname`, `firstname`) VALUES
